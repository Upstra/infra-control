...
export class AddVmwareFieldsToServer1752658928000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "server" DROP COLUMN "vmwareRamTotal"`);
    await queryRunner.query(`ALTER TABLE "server" DROP COLUMN "vmwareCpuMHz"`);
    await queryRunner.query(`ALTER TABLE "server" DROP COLUMN "vmwareCpuThreads"`);
    await queryRunner.query(`ALTER TABLE "server" DROP COLUMN "vmwareCpuCores"`);
    ...
    await queryRunner.query(`ALTER TABLE "server" DROP COLUMN "vmwareVCenterIp"`);
  }
}