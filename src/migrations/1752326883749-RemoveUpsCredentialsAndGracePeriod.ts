...
export class RemoveUpsCredentialsAndGracePeriod1752326883749
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ups" ADD "grace_period_off" integer NOT NULL DEFAULT 30`,
    );
    await queryRunner.query(
      `ALTER TABLE "ups" ADD "grace_period_on" integer NOT NULL DEFAULT 60`,
    );
    await queryRunner.query(
      `ALTER TABLE "ups" ADD "password" character varying NOT NULL DEFAULT ''`,
    );
    await queryRunner.query(
      `ALTER TABLE "ups" ADD "login" character varying NOT NULL DEFAULT ''`,
    );
  }
}
